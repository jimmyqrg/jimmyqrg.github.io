...
function checkEmailRestriction() {
  ...
  if (userEmail.toLowerCase().endsWith("@pausd.org")) {
    ...
    //     </p>
    //     <a href="https://login.jimmyqrg.com/?page=extend" style="display: inline-block; margin-top: 40px; padding: 12px 24px; background: rgba(255,255,255,0.1); border: 2px solid white; border-radius: 6px; color: white; text-decoration: none;">
    //       Return to Home
    //     </a>
    //   </div>
    // `;
