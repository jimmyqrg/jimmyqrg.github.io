// Function to open a game in a fullscreen iframe
  /* =====================================================
    === TAB CLOAK SYSTEM ================================
    ===================================================== */
  ...
  /* =====================================================
    === modify openGame() to include tab cloak ===========
    ===================================================== */
  ...
  openGame = function(url) {
    ...
    win.document.title = localStorage.getItem(CLOAK_TITLE_KEY) || "Loading...";

    const icon = localStorage.getItem(CLOAK_ICON_KEY);
    if (icon) {
    ...
    // Your original iframe injection:
