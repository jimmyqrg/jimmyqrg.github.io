// Utility script to update all URLs containing login.jimmyqrg.com with domain from currentDomain.txt
(function () {
  const updateUrls = async function () {
    try {
      ...
      document.querySelectorAll("[onclick]").forEach((element) => {
        ...
        if (onclick && onclick.includes("login.jimmyqrg.com")) {
      ...
      document.querySelectorAll("a[href]").forEach((link) => {
        ...
        if (href && href.includes("login.jimmyqrg.com")) {
          link.setAttribute(
            "href",
            href.replace(
              /https?:\/\/teacher\.jimmyqrg\.com/g,
      ...
      document.querySelectorAll("[src]").forEach((element) => {
        ...
        if (src && src.includes("login.jimmyqrg.com")) {
      ...
      document.querySelectorAll("[data-src]").forEach((element) => {
        ...
        if (dataSrc && dataSrc.includes("login.jimmyqrg.com")) {
          element.setAttribute(
            "data-src",
            dataSrc.replace(
              /https?:\/\/teacher\.jimmyqrg\.com/g,
      ...
      while ((node = walker.nextNode())) {
        if (node.textContent.includes("login.jimmyqrg.com")) {
      ...
      window.currentDomain = "login.jimmyqrg.com";
      window.currentDomainCache = "login.jimmyqrg.com";
    }
  };
