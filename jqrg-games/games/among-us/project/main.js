...
window.DOMElementHandler = class extends self.DOMHandler {
    ...
    _OnCreate(e) {
        ...
        this._elementMap.set(t, i),
        e.isVisible || (i.style.display = "none");
...
;
{
    ...
    window.RuntimeInterface = class i {
        constructor(e) {
            ...
            !this._useWorker || "undefined" != typeof OffscreenCanvas && navigator.userActivation && ("module" !== this._scriptsType || n()) || (this._useWorker = !1),
            w(this._exportType) && this._useWorker && (console.warn("[C3 runtime] Worker mode is enabled and supported, but is disabled in WebViews due to crbug.com/923007. Reverting to DOM mode."),
            this._useWorker = !1),
        ...
        MaybeForceBodySize() {
            if (this.IsiOSWebView()) {
                ...
                t.height = e.height = n + "px",
                t.width = e.width = s + "px"
            }
        }
        ...
        async _InitDOM(e, i) {
            ...
            Array.isArray(e.workerDependencyScripts) && s.unshift(...e.workerDependencyScripts),
                ...
                for (let[e,o] of s)
                    ...
                    e === i)
                        try {
                            ...
                            "preview" !== this._exportType || n[e] || this._ReportProjectMainScriptError(e, "main script did not run to completion")
                        } catch (t) {
                            this._ReportProjectMainScriptError(e, t)
                        }
                    else
                        ("scriptsInEvents.js" === e || e.endsWith("/scriptsInEvents.js")) && await t(o, this._scriptsType)
            } else if (e.projectScripts && e.projectScripts.length > 0)
                try {
                    if (await Promise.all(e.projectScripts.map((e => t(e[1], this._scriptsType)))),
                    Object.values(n).some((e => !e)))
                        return void self.setTimeout(( () => this._ReportProjectScriptError(n)), 100)
                } catch (e) {
                    return console.error("[Preview] Error loading project scripts: ", e),
            ...
            if ("preview" === this._exportType && "object" != typeof self.C3.ScriptsInEvents) {
                ...
                return console.error("[C3 runtime] " + e),
                void alert(e)
            }
        ...
        _ReportProjectScriptError(e) {
            ...
            console.error("[Preview] " + t),
            alert(t)
        }
        _ReportProjectMainScriptError(e, t) {
            this._RemoveLoadingMessage(),
            console.error(`[Preview] Failed to load project main script (${e}): `, t),
            alert(`Failed to load project main script (${e}). Check all your JavaScript code has valid syntax. Press F12 and check the console for error details.`)
        }
        ...
        async RequestPermissions(e) {
            ...
            if (this.IsiOSCordova())
                return !0;
            for (const t of e)
                if (!await this._HasPermission(t) && !1 === await this._RequestPermission(t))
                    return !1;
            return !0
        }
        ...
        _BinaryStringToBlob(e, t) {
            let i, s, n = e.length, o = n >> 2, a = new Uint8Array(n), r = new Uint32Array(a.buffer,0,o);
            for (i = 0,
            s = 0; i < o; ++i)
...
}
{
    ...
    const i = new Map([["OSLeft", "MetaLeft"], ["OSRight", "MetaRight"]])
      , s = {
    ...
    async function d(e, t, i) {
        ...
        return o.setAttribute("width", t + "px"),
    ...
    const f = "runtime"
      , g = class extends self.DOMHandler {
        constructor(e) {
            ...
            e.AddRuntimeComponentMessageHandler("canvas", "update-size", (e => this._OnUpdateCanvasSize(e))),
            ...
            i.addEventListener("pointerdown", h)) : i.addEventListener("touchstart", h),
        ...
        Attach() {
            ...
            this._iRuntime.UsesWorker() && void 0 !== window.onpointerrawupdate && self === self.top ? (this._pointerRawUpdateRateLimiter = new self.RateLimiter(( () => this._DoSendPointerRawUpdate()),5),
        ...
        _OnSimulatedResize(e, t, i) {
            ...
            this._simulatedResizeTimerId = -1,
            s != e || n != t ? this._PostRuntimeEvent("window-resize", {
                innerWidth: s,
                innerHeight: n,
                devicePixelRatio: window.devicePixelRatio
        ...
        _OnMouseEventAsPointer(e, i) {
            ...
            ("pointerdown" === e && 0 !== o || "pointerup" === e && 0 !== i.buttons) && (e = "pointermove"),
            this._PostToRuntimeMaybeSync(e, {
                pointerId: 1,
                pointerType: "mouse",
                button: i.button,
        ...
        _OnPointerEvent(e, t) {
            ...
            let i = 0;
            if ("mouse" === t.pointerType && (i = this._mousePointerLastButtons),
            this._PostToRuntimeMaybeSync(e, {
            ...
            "mouse" === t.pointerType) {
                let i = "mousemove";
                "pointerdown" === e ? i = "mousedown" : "pointerup" === e && (i = "mouseup"),
        ...
        _OnUpdateCanvasSize(e) {
            ...
            this._isFirstSizeUpdate && (i.style.display = "",
...
}
{
    ...
    self.JobSchedulerDOM = class {
        constructor(e) {
            ...
            "preview" === e.GetExportType() ? this._baseUrl += "c3/workers/" : this._baseUrl += e.GetScriptFolder(),
...
}
{
    ...
    self.AudioDOMHandler = class extends self.DOMHandler {
        ...
        async _CreateAudioContext(e) {
            ...
            if (this.SupportsWebMOpus() || (t.sampleRate = 48e3),
        ...
        _ReconnectEffects(e) {
            ...
            for (const i of this.audioInstancesByTag(e))
                i.Reconnect(t);
        ...
        DecodeAudioData(e, t) {
            return t ? this._iRuntime._WasmDecodeWebMOpus(e).then((e => {
                ...
                return t.getChannelData(0).set(e),
                t
            }
            )) : new Promise(( (t, i) => {
        ...
        *audioInstancesByTag(e) {
        ...
        async _Play(e) {
            ...
            this._lastPlayedTag = o,
            this._AddPendingTag(o);
            try {
                this._lastAudioInstance = await this._GetAudioInstance(t, i, s, o, n),
                c ? (this._lastAudioInstance.SetPannerEnabled(!0),
                this._lastAudioInstance.SetPan(c.x, c.y, c.angle, c.innerAngle, c.outerAngle, c.outerGain),
                c.hasOwnProperty("uid") && this._lastAudioInstance.SetUID(c.uid)) : this._lastAudioInstance.SetPannerEnabled(!1),
        ...
        _Stop(e) {
            const t = e.tag;
            for (const e of this.audioInstancesByTag(t))
                e.Stop()
        }
        _StopAll() {
            for (const e of this._audioInstances)
        ...
        _SetEffectParam(e) {
            ...
            !r || i < 0 || i >= r.length || (r[i].SetParam(s, n, o, a),
            this._PostUpdatedFxState())
        }
        _RemoveEffects(e) {
...
self.C3WebAudioBuffer = class extends self.C3AudioBuffer {
    ...
    async _Fetch() {
        ...
        if ("cordova" === e.GetExportType() && e.IsRelativeURL(this._url) && "file:" === location.protocol)
...
}
{
    ...
    const s = class extends self.DOMElementHandler {
        constructor(t) {
            super(t, e),
            this.AddDOMElementMessageHandler("scroll-to-bottom", (e => this._OnScrollToBottom(e)))
        }
        CreateElement(e, s) {
            let n;
            const o = s.type;
            return "textarea" === o ? (n = document.createElement("textarea"),
            n.style.resize = "none") : (n = document.createElement("input"),
            n.type = o),
...
}
{
    ...
    const i = class extends self.DOMElementHandler {
        ...
        CreateElement(e, i) {
            ...
            s.addEventListener("change", ( () => this.PostToRuntimeElement("change", e, {
    ...
    const i = class extends self.DOMElementHandler {
        ...
        UpdateState(e, t) {
            ...
            const i = t.value
              , s = t.max;
            s > 0 && i >= 0 ? (e.max = s,
            e.value = i) : (e.removeAttribute("value"),
        ...
        async _OnRequestWakeLock() {
            if (!this._screenWakeLock)
                try {
                    ...
                    console.warn("[Construct 3] Failed to acquire screen wake lock: ", e),
